...
We think about quality control in terms of a more passive, ad hoc approach (which we refer to as data profiling), and a more explicity, active quality control we refer to as assertive programming. 

Data profiling is passive in that it doesn't involve testing any specific aspects of the data, but rather uses informative summaries to help you identify flag potential issues like questionable data entries, extreme/unlikely values, and patterns of missing data
...
LM <- readRDS("~/FWS_Projects/Requests_for_assistance/data-mgt-with-r/docs/adam/data/LM.rds")
