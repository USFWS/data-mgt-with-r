...
???
How do you evaludate whether a data workflow is a "good" one. To do this, you need some criteria from which to measure success. You can probably imagine a list of these, but for this webinar, we focus on these six.
...
styler - I'll talk about in more detail on the next slide. 
...
.pull-left-30[
A package to reformat R code

- Can format to a specific style or focus on specific issue (e.g., spacing) 

- Flexible for user to customize their own style
]
...
???
styler allows you to interactively restyle selected text, files, or entire projects. It isincludes an RStudio add-in, the easiest way to re-style existing code.
