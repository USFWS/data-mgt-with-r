...
???
- This presentation will roughly follow the project and data life cycles that Jared and Maren introduced in the previous webinar on data management. 
- Both cycles start with a Planning step, and we will start with recommended steps that we think should be considered during the planning step and cover some associated R tools.
...
???
- We will progress through data life cycle: the Acquire, Process, Analyze, Share and Achive steps.
...
???
Let's first walk through the traditional data workflow that is probably familiar to everybody here.
