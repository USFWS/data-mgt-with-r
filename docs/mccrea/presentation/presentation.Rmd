...
background-size: 90%
class: hide-logo
# ![:scale 7%](images/Rlogo.svg) data workflow `r icon::fa("smile")`
...
background-size: 90%
class: hide-logo
# ![:scale 7%](images/Rlogo.svg) data workflow `r icon::fa("grin")`
...
background-size: 90%
class: hide-logo
# ![:scale 7%](images/Rlogo.svg) data workflow `r icon::fa("grin-beam")`
...
background-size: 90%
class: hide-logo
# ![:scale 7%](images/Rlogo.svg) data workflow `r icon::fa("grin-squint")`
...
background-size: 90%
class: hide-logo
# ![:scale 7%](images/Rlogo.svg) data workflow `r icon::fa("grin-stars")`
...
### `r icon::fa("sitemap")` Chose a  standardized file directory structure
