...
Presenters: [McCrea Cobb](mailto:mccrea_cobb@fws.gov) and [Adam Smith](mailto:adam_d_smith@fws.gov)
...
4. A data workflow with R
    + **Planning** an RStudio project (*McCrea*)
        ...
        + Version control
            + Storing versions
            + Collaboration
    + **Documenting** data and scripts with R (*Adam*)
        + rOxygen 
...
5. An example R project / Live demo (*Both*)
